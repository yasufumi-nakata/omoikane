...
evidence digest、live verifier quorum / roster freshness / revocation status /
signed-current timestamp / replay-unique guard 付き verifier receipt、
Council+Guardian 署名付き ledger entry に束縛する。
