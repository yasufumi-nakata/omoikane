...
- gap-report は tracked worktree marker residue に加えて追跡対象/未追跡の build・cache・platform metadata 生成物 path manifest を digest-bound に監査し、raw generated artifact payload を読まずに all-zero gate の外へ出す
