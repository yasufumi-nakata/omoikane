...
- shared Sensory Loopback では participant ごとの BioData confidence gate digest、feature-window drift gate digest、fresh calibration refresh digest、threshold digest、latency weight policy authority digest、binding digest、raw BioData / drift / refresh / timing / weight-policy authority / gate payload 非保存を確認する
