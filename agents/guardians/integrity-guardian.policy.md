...
- gap-report は top-level eval inventory、decision-log README index、tracked worktree marker residue、追跡対象/未追跡の build・cache・platform metadata 生成物 path manifest を digest-bound に監査し、raw generated artifact payload を読まずに all-zero gate の外へ出す
