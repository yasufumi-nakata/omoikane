...
- shared Sensory Loopback では participant ごとの BioData confidence gate digest、feature-window drift gate digest、fresh calibration refresh digest、threshold digest、binding digest、raw BioData / drift / refresh / gate payload 非保存を確認する
