...
fail-closed に伝播し、delivery block、shared session hold、safe baseline、
revocation ref、guard digest、raw refresh / revocation payload redaction を確認する。
...
- `sensory_loopback_biodata_arbitration.yaml`
- `sensory_loopback_calibration_refresh_state_guard.yaml`
