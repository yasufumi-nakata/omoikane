...
- `parallel_codex_post_commit_publication.yaml`
  - commit-finalized Parallel Codex handoff が push / remote-head verification だけでなく ls-remote output の observed head/ref digest、GitHub protected branch provider policy receipt、required verification checks、raw provider payload 非保存まで束縛すること
