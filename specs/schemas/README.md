...
- `parallel_codex_integration_execution_receipt.schema`
  - integration-ready batch receipt を main checkout 適用直前の ordered apply plan と post-apply verification manifest に縮約し、source batch digest、current head、apply step digest、raw batch / apply / worker / verification payload 非保存を固定する
