...
同じ continuity subject に束縛することを確認する。
...
signer roster digest / signer key ref / funding policy signature digest / network response digest も確認し、
...
accepted authority refs / verifier jurisdictions / route refs / response digest set に束ね、
