...
- `guardian-witnessed-procedural-skill-enactment-v1` で
  temp workspace materialization、actual command receipt、cleanup、sandbox-only delivery を固定
canonical schema:
