...
6. shared fabric capacity しか観測できない場合でも、member shortfall を明示し、劣化許可ではなく standby 退避 signal に束縛する
7. sustainable economy の社会制度モデルは research frontier に残し、runtime は床値保護、同意付き補助、shared fabric shortfall receipt だけを検証する
