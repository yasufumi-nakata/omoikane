...
6. voluntary subsidy の funding policy signature は法域付き signer roster、live HTTP verifier receipt、multi-jurisdiction verifier quorum、revocation registry、audit authority の digest chain に束縛され、raw authority payload / verifier payload は保存しない
