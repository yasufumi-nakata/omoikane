...
`build_request -> target-aware patch descriptor -> sandbox apply -> actual temp-workspace eval execution bind -> parsed A/B eval report -> rollout classify -> staged rollout`
