...
publication digest に束縛する。加えて GitHub protected branch provider policy
...
remote head mismatch、protected branch が未保護 / unknown、または source execution /
