...
`worker result -> signed worker identity evidence + remote metadata + remote source revocation evidence + patch digest + changed files + verification result -> schema-bound ingestion receipt`
