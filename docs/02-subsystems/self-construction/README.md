...
`worker result -> signed worker identity evidence + remote metadata + patch digest + changed files + verification result -> schema-bound ingestion receipt`
