...
required verification checks を completed/success として check-run digest に束縛する。
...
missing / failure / stale commit、または source execution / commit finalization が未 ready の場合は schema-bound のまま
