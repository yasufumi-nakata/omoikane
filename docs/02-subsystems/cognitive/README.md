...
最小の L3 eval として扱う。
また cognitive audit follow-up では、JP-13 / US-CA reviewer quorum を
authenticated non-loopback verifier transport trace に束縛する
`cognitive_audit_verifier_transport.yaml` も L3/L4 境界 eval として扱う。
