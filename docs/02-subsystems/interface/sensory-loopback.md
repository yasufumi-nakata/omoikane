...
- `interface.sensory_loopback.v0.idl` を追加し、
  `open_session / bind_latency_weight_policy_verifier_quorum / bind_participant_biodata_arbitration / deliver_bundle / stabilize / snapshot / capture_artifact_family / snapshot_artifact_family` を定義
- `sensory_loopback_session.schema` /
  ...
  `sensory_loopback_latency_weight_policy_verifier_quorum.schema` を追加
