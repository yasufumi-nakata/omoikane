...
""",
        ...
        *,
        ...
        return {
            ...
            "validation": {
                ...
                "research_evidence_request_digest_bound": (
                    research_evidence_exchange_validation["request_digest_bound"]
                ),
                "research_evidence_report_digest_bound": (
                    research_evidence_exchange_validation["report_digest_bound"]
                ),
                "research_evidence_exchange_digest_bound": (
                    research_evidence_exchange_validation["exchange_digest_bound"]
                ),
                "research_evidence_refs_bound": research_evidence_exchange_validation[
                    "evidence_refs_bound"
                ],
                "research_evidence_verifier_bound": (
                    research_evidence_exchange_validation["evidence_verifier_bound"]
                ),
                "research_evidence_verifier_digest_bound": (
                ...
                "research_evidence_ledger_entry_appended": (
                    research_evidence_exchange_validation["continuity_ledger_entry_appended"]
                ),
                "research_evidence_ledger_entry_digest_bound": (
                    research_evidence_exchange_validation[
                        "continuity_ledger_entry_digest_bound"
                    ]
                ),
                "research_evidence_ledger_payload_ref_bound": (
                    research_evidence_exchange_validation[
                        "continuity_ledger_payload_ref_bound"
                    ]
                ),
                "research_evidence_decision_authority_claimed": (
                    research_evidence_exchange_validation["decision_authority_claimed"]
                ),
    ...
    def run_energy_budget_subsidy_demo(self) -> Dict[str, Any]:
        ...
        primary_verifier_authority_ref = (
            "authority://energy-budget.jp/subsidy-signer-roster/verifier-primary"
        )
        primary_verifier_jurisdiction = "JP-13"
        primary_verifier_route_ref = (
            "route://energy-budget.jp/subsidy-signer-roster/live-primary"
        )
        backup_verifier_ref = "verifier://energy-budget.sg/signer-roster"
        backup_challenge_ref = (
            "challenge://energy-budget-subsidy/signer-roster/sg-backup/v1"
        )
        backup_authority_chain_ref = (
            "authority://energy-budget.sg/subsidy-signer-roster"
        )
        backup_trust_root_ref = (
            "root://energy-budget.sg/subsidy-signer-roster-pki"
        )
        backup_trust_root_digest = (
            "sha256:energy-budget-sg-subsidy-signer-roster-pki-v1"
        )
        backup_verifier_authority_ref = (
            "authority://energy-budget.sg/subsidy-signer-roster/verifier-backup"
        )
        backup_verifier_jurisdiction = "SG-01"
        backup_verifier_route_ref = (
            "route://energy-budget.sg/subsidy-signer-roster/live-backup"
        )
        live_verifier_payload = {
            ...
            "verifier_authority_ref": primary_verifier_authority_ref,
            "verifier_jurisdiction": primary_verifier_jurisdiction,
            "verifier_route_ref": primary_verifier_route_ref,
        ...
        backup_verifier_payload = {
            **live_verifier_payload,
            "checked_at": "2026-04-26T00:00:01Z",
            "verifier_ref": backup_verifier_ref,
            "challenge_ref": backup_challenge_ref,
            "verifier_authority_ref": backup_verifier_authority_ref,
            "verifier_jurisdiction": backup_verifier_jurisdiction,
            "verifier_route_ref": backup_verifier_route_ref,
        ...
        verifier_quorum_receipt = (
            self.energy_budget.build_subsidy_signer_roster_verifier_quorum_receipt(
                verifier_receipts=[
                    live_verifier_receipt,
                    backup_live_verifier_receipt,
                ],
                primary_verifier_receipt_digest=live_verifier_receipt["digest"],
            )
        )
        subsidy_receipt = self.energy_budget.evaluate_voluntary_subsidy(
            ...
            signer_roster_verifier_quorum_receipt=verifier_quorum_receipt,
        )
        ...
        return {
            ...
            "validation": {
                "ok": bool(
                    ...
                    and subsidy_receipt["signer_roster_verifier_quorum_bound"]
                ...
                "signer_roster_verifier_quorum_status": subsidy_receipt[
                    "signer_roster_verifier_quorum_receipt"
                ]["quorum_status"],
                "signer_roster_verifier_quorum_accepted_probe_count": (
                    subsidy_receipt["signer_roster_verifier_quorum_receipt"][
    ...
    def run_memory_replication_demo(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "validation": {
                ...
                "long_term_media_renewal_registry_verifier_bound": replication_validation[
                ...
                "raw_media_registry_payload_stored": replication_validation[
    ...
    def run_identity_confirmation_demo(self) -> Dict[str, Any]:
        ...
        ledger_event = self.ledger.append(
            ...
            payload={
                ...
                "witness_revocation_verifier_quorum_status": profile[
        ...
        verifier_blocked_profile = self.identity.confirm_identity(
            identity.identity_id,
            consent_ref="consent://identity-confirmation-demo/verifier-blocked",
            scheduler_stage_ref="scheduler://method-a/identity-confirmation-verifier-blocked",
            episodic_recall_ref="episodic://identity-confirmation-demo/verifier-recall",
            self_model_ref="self-model://identity-confirmation-demo/verifier-snapshot",
            episodic_recall_score=0.93,
            self_model_alignment_score=0.89,
            self_report={
                "report_ref": "self-report://identity-confirmation-demo/verifier-blocked",
                "statement": "I confirm continuity, but live revocation verifier quorum is incomplete.",
                "continuity_score": 0.91,
            },
            witness_receipts=[
                {
                    "witness_id": "witness://identity-confirmation/clinician-verifier-current",
                    "witness_role": "clinician",
                    "observation_ref": "observation://identity-confirmation/verifier-recall",
                    "alignment_score": 0.89,
                },
                {
                    "witness_id": "witness://identity-confirmation/guardian-verifier-current",
                    "witness_role": "guardian",
                    "observation_ref": "observation://identity-confirmation/verifier-self-model",
                    "alignment_score": 0.9,
                },
            ],
        ...
        return {
            ...
            "validation": {
                **validation,
                ...
                "revocation_verifier_quorum_fail_closed": (
                    verifier_blocked_profile["result"] == "failed"
                    and verifier_blocked_profile["active_transition_allowed"] is False
                    and "witness-revocation-verifier-quorum-not-bound"
                    in verifier_blocked_profile["failure_reasons"]
                    and verifier_blocked_validation["ok"] is False
                    and verifier_blocked_validation["confirmation_digest_bound"] is True
                    and verifier_blocked_validation[
                ...
                "ledger_event_bound": (
                    ...
                    and ledger_event.payload[
                        "witness_revocation_verifier_quorum_digest"
                    ]
