...
MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_READBACK_POLICY_ID = (
    "long-term-media-renewal-registry-endpoint-certificate-ct-log-readback-v1"
)
MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID = (
...
def _memory_replication_media_renewal_digest_payload(
    receipt: Dict[str, Any],
) -> Dict[str, Any]:
    return {key: value for key, value in receipt.items() if key != "digest"}
...
def _memory_replication_media_proof_digest_payload(
    ...
    return {key: value for key, value in proof.items() if key != "proof_digest"}
...
class MemoryReplicationService:
    ...
    def profile(self) -> Dict[str, Any]:
        return {
            ...
            "key_succession_signer_roster_quorum_policy_id": (
                MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_POLICY_ID
            ),
            "key_succession_signer_roster_jurisdictions": list(
                MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS
            ),
            ...
            "long_term_media_renewal_registry_endpoint_certificate_ct_log_readback_policy_id": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_READBACK_POLICY_ID
            ),
            "long_term_media_renewal_registry_endpoint_certificate_ct_log_quorum_policy_id": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID
            ),
            "long_term_media_renewal_registry_endpoint_certificate_sct_policy_authority_policy_id": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_POLICY_AUTHORITY_POLICY_ID
            ),
            ...
            "long_term_media_renewal_registry_jurisdictions": list(
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS
            ),
            "long_term_media_renewal_registry_quorum_threshold": (
            ...
            "long_term_media_renewal_registry_endpoint_certificate_ct_log_quorum_required_log_count": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_REQUIRED_LOG_COUNT
            ),
            "long_term_media_renewal_registry_endpoint_certificate_sct_timestamp_window_seconds": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_TIMESTAMP_WINDOW_SECONDS
            ),
    ...
    def replicate(self, identity_id: str, manifest: Dict[str, Any]) -> Dict[str, Any]:
        ...
        long_term_media_renewal = self._build_long_term_media_renewal_receipt(
            identity_id=identity_id,
            source_manifest_ref=source_manifest_ref,
            source_manifest_digest=source_manifest_digest,
        ...
        session = {
            ...
            "long_term_media_renewal": long_term_media_renewal,
    ...
    def validate_session(
        ...
        *,
        ...
        if not isinstance(policy, dict):
            ...
            if (
                policy.get("key_succession_signer_roster_quorum_policy_id")
                != MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_POLICY_ID
            ):
                errors.append(
                    "replication_policy.key_succession_signer_roster_quorum_policy_id mismatch"
                )
            if (
                policy.get("key_succession_signer_roster_jurisdictions")
                != list(MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS)
            ):
                errors.append(
                    "replication_policy.key_succession_signer_roster_jurisdictions mismatch"
                )
            if (
                policy.get("key_succession_signer_roster_quorum_threshold")
                != MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_THRESHOLD
            ):
                errors.append(
            ...
            if (
                policy.get("long_term_media_renewal_policy_id")
                != MEMORY_REPLICATION_MEDIA_RENEWAL_POLICY_ID
            ):
                errors.append(
            ...
            if (
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_endpoint_certificate_ct_log_readback_policy_id mismatch"
                )
            if (
                policy.get(
                    "long_term_media_renewal_registry_endpoint_certificate_ct_log_quorum_policy_id"
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_endpoint_certificate_ct_log_quorum_policy_id mismatch"
                )
            if (
                policy.get(
                    "long_term_media_renewal_registry_endpoint_certificate_sct_policy_authority_policy_id"
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_endpoint_certificate_sct_policy_authority_policy_id mismatch"
                )
            if (
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_targets mismatch"
                )
            if (
                policy.get("long_term_media_renewal_refresh_interval_days")
                != MEMORY_REPLICATION_MEDIA_RENEWAL_REFRESH_INTERVAL_DAYS
            ):
                errors.append(
            ...
            if (
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_target_horizon_years mismatch"
                )
            if (
                policy.get("long_term_media_renewal_registry_jurisdictions")
                != list(MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS)
            ):
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_jurisdictions mismatch"
                )
            if (
                policy.get("long_term_media_renewal_registry_quorum_threshold")
                != MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_QUORUM_THRESHOLD
            ):
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_quorum_threshold mismatch"
                )
            if (
                policy.get("long_term_media_renewal_registry_response_timeout_ms")
                != MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_RESPONSE_TIMEOUT_MS
            ):
                errors.append(
            ...
            if (
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_endpoint_certificate_ct_log_quorum_required_log_count mismatch"
                )
            if (
                policy.get(
                    "long_term_media_renewal_registry_endpoint_certificate_sct_timestamp_window_seconds"
                ...
                errors.append(
                    "replication_policy.long_term_media_renewal_registry_endpoint_certificate_sct_timestamp_window_seconds mismatch"
                )
        ...
        consensus_merkle_root: Any = None
        ...
        long_term_media_renewal_validation = self._validate_long_term_media_renewal(
            session.get("long_term_media_renewal"),
            identity_id=session.get("identity_id"),
            source_manifest_ref=session.get("source_manifest_ref"),
            source_manifest_digest=source_manifest_digest,
            source_segment_ids=source_segment_ids,
        ...
        return {
            ...
            "key_succession_multi_jurisdiction_signer_roster_quorum_bound": (
                key_succession_validation[
                    "multi_jurisdiction_signer_roster_quorum_bound"
                ]
            ),
            ...
            "long_term_media_renewal_bound": (
                long_term_media_renewal_validation["bound"]
            ),
            "long_term_media_renewal_targets": (
                long_term_media_renewal_validation["target_ids"]
            ),
            "long_term_media_renewal_readback_ok": (
                long_term_media_renewal_validation["readback_ok"]
            ),
            "long_term_media_renewal_refresh_interval_days": (
                long_term_media_renewal_validation["refresh_interval_days"]
            ),
            "long_term_media_renewal_target_horizon_years": (
            ...
            "long_term_media_renewal_registry_verifier_bound": (
                long_term_media_renewal_validation["registry_verifier_bound"]
            ),
            ...
            "long_term_media_renewal_registry_endpoint_certificate_ct_log_bound": (
                long_term_media_renewal_validation[
                    "registry_endpoint_certificate_ct_log_bound"
                ]
            ),
            "long_term_media_renewal_registry_endpoint_certificate_ct_log_quorum_ok": (
                long_term_media_renewal_validation[
                    "registry_endpoint_certificate_ct_log_quorum_ok"
                ]
            ),
            ...
            "raw_media_payload_stored": long_term_media_renewal_validation[
            ...
            "raw_media_registry_payload_stored": long_term_media_renewal_validation[
    ...
    def _build_key_succession_receipt(
        ...
        *,
        ...
        signer_roster_quorum = self._build_key_succession_signer_roster_quorum(
            identity_id=identity_id,
            source_manifest_digest=source_manifest_digest,
            successor_key_digest=successor_key_digest,
            primary_signer_roster_policy=signer_roster_policy,
        )
        receipt = {
            ...
            "signer_roster_quorum": signer_roster_quorum,
    ...
    def _build_key_succession_signer_roster_policy(
        ...
        *,
        ...
        jurisdiction: str = MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTION,
    ) -> Dict[str, Any]:
        policy_ref = (
    ...
    def _build_key_succession_signer_roster_quorum(
        self,
        *,
        identity_id: str,
        source_manifest_digest: str,
        successor_key_digest: str,
        primary_signer_roster_policy: Dict[str, Any],
    ) -> Dict[str, Any]:
        jurisdiction_policies = [primary_signer_roster_policy]
        for jurisdiction in MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS:
            if jurisdiction == primary_signer_roster_policy["jurisdiction"]:
                continue
            jurisdiction_policies.append(
                self._build_key_succession_signer_roster_policy(
                    identity_id=identity_id,
                    source_manifest_digest=source_manifest_digest,
                    successor_key_digest=successor_key_digest,
                    jurisdiction=jurisdiction,
        ...
        jurisdiction_policy_refs = [
            policy["policy_ref"] for policy in jurisdiction_policies
        ]
        jurisdiction_policy_digests = [
            policy["digest"] for policy in jurisdiction_policies
        ]
        signer_roster_digest_set = [
            policy["signer_roster_digest"] for policy in jurisdiction_policies
        ]
        signature_digest_set = [
            signer["signature_digest"]
        ...
        receipt = {
            ...
            "policy_ref": (
                "policy://memory-replication/key-succession/"
                "multi-jurisdiction-signer-roster-quorum-v1"
            ),
            "required_jurisdictions": list(
                MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS
            ),
            "accepted_jurisdictions": [
                policy["jurisdiction"] for policy in jurisdiction_policies
            ],
            "quorum_threshold": (
                MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_THRESHOLD
            ),
    ...
    def _validate_key_succession(
        ...
        *,
        ...
        signer_roster_quorum_validation = (
            self._validate_key_succession_signer_roster_quorum(
                receipt.get("signer_roster_quorum"),
                identity_id=identity_id,
                source_manifest_digest=source_manifest_digest,
                successor_key_digest=receipt.get("successor_key_digest"),
                primary_signer_roster_policy=receipt.get("signer_roster_policy"),
                errors=local_errors,
            )
        )
        multi_jurisdiction_signer_roster_quorum_bound = (
            signer_roster_quorum_validation["bound"]
        )
        multi_jurisdiction_signer_roster_quorum_ok = (
            signer_roster_quorum_validation["quorum_ok"]
        )
        raw_signer_roster_payload_stored = (
            raw_signer_roster_payload_stored
            or signer_roster_quorum_validation["raw_signer_roster_payload_stored"]
        )
    ...
    def _validate_key_succession_signer_roster_policy(
        ...
        *,
        ...
        errors: List[str],
        expected_jurisdiction: str = MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTION,
        error_prefix: str = "key_succession.signer_roster_policy",
    ) -> Dict[str, Any]:
        local_errors: List[str] = []
        raw_signer_roster_payload_stored = False
        ...
        if jurisdiction != expected_jurisdiction:
            local_errors.append(f"{error_prefix}.jurisdiction mismatch")
        self._require_non_empty_string(
        ...
        if required_signer_roles != list(MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROLES):
            local_errors.append(
                f"{error_prefix}.required_signer_roles mismatch"
            )
        if isinstance(receipt.get("signer_roster_digest"), str):
            ...
            if receipt["signer_roster_digest"] != expected_roster_digest:
                local_errors.append(
                    f"{error_prefix}.signer_roster_digest mismatch"
                )
            else:
        ...
        if (
            ...
            local_errors.append(
                f"{error_prefix}.quorum_threshold mismatch"
            )
        ...
        if not isinstance(accepted_signers, list):
            local_errors.append(
                f"{error_prefix}.accepted_signers must be a list"
            )
            accepted_signers = []
        for index, signer in enumerate(accepted_signers):
            if not isinstance(signer, dict):
                ...
                local_errors.append(
                    f"{error_prefix}.accepted_signers[{index}] must be an object"
                )
                continue
            self._require_non_empty_string(
                signer.get("signer_ref"),
                f"{error_prefix}.accepted_signers[{index}].signer_ref",
                local_errors,
            )
            signer_role = signer.get("signer_role")
            self._require_non_empty_string(
                signer_role,
                f"{error_prefix}.accepted_signers[{index}].signer_role",
                local_errors,
            )
            ...
            if signer.get("jurisdiction") != jurisdiction:
                local_errors.append(
                    f"{error_prefix}.accepted_signers[{index}].jurisdiction mismatch"
                )
            self._require_digest(
                signer.get("signature_digest"),
                f"{error_prefix}.accepted_signers[{index}].signature_digest",
                local_errors,
            )
        ...
        if not signer_roster_quorum_ok:
            local_errors.append(
                f"{error_prefix}.accepted_signers must satisfy signer roster quorum"
            )

        if receipt.get("quorum_status") != "complete":
            local_errors.append(
                f"{error_prefix}.quorum_status must equal 'complete'"
            )
        if receipt.get("raw_signer_roster_payload_stored") is not False:
            raw_signer_roster_payload_stored = True
            local_errors.append(
                f"{error_prefix}.raw_signer_roster_payload_stored must be false"
            )
        digest = receipt.get("digest")
        self._require_digest(
            digest,
            f"{error_prefix}.digest",
            local_errors,
        )
        if isinstance(digest, str):
            expected_digest = sha256_text(
    ...
    def _validate_key_succession_signer_roster_quorum(
        self,
        receipt: Any,
        *,
        identity_id: Any,
        source_manifest_digest: Any,
        successor_key_digest: Any,
        primary_signer_roster_policy: Any,
        errors: List[str],
    ) -> Dict[str, Any]:
        local_errors: List[str] = []
        raw_jurisdiction_policy_payload_stored = False
        ...
        if receipt.get("kind") != "memory_replication_key_succession_signer_roster_quorum":
            local_errors.append("key_succession.signer_roster_quorum.kind mismatch")
        if (
            receipt.get("policy_id")
            != MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_POLICY_ID
        ):
            local_errors.append("key_succession.signer_roster_quorum.policy_id mismatch")
        self._require_non_empty_string(
            receipt.get("policy_ref"),
            "key_succession.signer_roster_quorum.policy_ref",
            local_errors,
        )
        required_jurisdictions = self._validate_string_list(
            receipt.get("required_jurisdictions"),
            "key_succession.signer_roster_quorum.required_jurisdictions",
            local_errors,
        ...
        if required_jurisdictions != list(
            ...
            local_errors.append(
                "key_succession.signer_roster_quorum.required_jurisdictions mismatch"
            )
        accepted_jurisdictions = self._validate_string_list(
            receipt.get("accepted_jurisdictions"),
            "key_succession.signer_roster_quorum.accepted_jurisdictions",
            local_errors,
            minimum=MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_THRESHOLD,
            unique=True,
        )
        if set(accepted_jurisdictions) != set(
            MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS
        ):
            local_errors.append(
                "key_succession.signer_roster_quorum.accepted_jurisdictions mismatch"
            )
        if (
            receipt.get("quorum_threshold")
            != MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_THRESHOLD
            ...
            local_errors.append(
                "key_succession.signer_roster_quorum.quorum_threshold mismatch"
            )

        jurisdiction_policies = receipt.get("jurisdiction_policies")
        if not isinstance(jurisdiction_policies, list):
            local_errors.append(
                "key_succession.signer_roster_quorum.jurisdiction_policies must be a list"
            )
            jurisdiction_policies = []
        if len(jurisdiction_policies) != len(
            MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS
        ):
            local_errors.append(
                "key_succession.signer_roster_quorum.jurisdiction_policies length mismatch"
            )

        policy_by_jurisdiction: Dict[str, Dict[str, Any]] = {}
        for index, policy in enumerate(jurisdiction_policies):
            if not isinstance(policy, dict):
                nested_policies_bound = False
                nested_policy_quorums_ok = False
                local_errors.append(
                    "key_succession.signer_roster_quorum."
                    f"jurisdiction_policies[{index}] must be an object"
                )
                continue
            ...
            policy_validation = self._validate_key_succession_signer_roster_policy(
                policy,
                identity_id=identity_id,
                source_manifest_digest=source_manifest_digest,
                successor_key_digest=successor_key_digest,
                ...
                error_prefix=(
                    "key_succession.signer_roster_quorum."
                    f"jurisdiction_policies[{index}]"
                ),
            )
            nested_policies_bound = nested_policies_bound and policy_validation["bound"]
            nested_policy_quorums_ok = (
                nested_policy_quorums_ok and policy_validation["quorum_ok"]
            )
            raw_signer_roster_payload_stored = (
                raw_signer_roster_payload_stored
                or policy_validation["raw_signer_roster_payload_stored"]
            )
            if isinstance(jurisdiction, str) and jurisdiction:
                policy_by_jurisdiction[jurisdiction] = policy

        if set(policy_by_jurisdiction) != set(
            MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS
        ):
            local_errors.append(
                "key_succession.signer_roster_quorum.jurisdiction_policies jurisdiction set mismatch"
            )
            nested_policies_bound = False

        if isinstance(primary_signer_roster_policy, dict):
            primary_digest = primary_signer_roster_policy.get("digest")
            jp_policy = policy_by_jurisdiction.get(
                MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTION
            )
            if not isinstance(jp_policy, dict) or jp_policy.get("digest") != primary_digest:
                local_errors.append(
                    "key_succession.signer_roster_quorum must bind primary JP-13 signer_roster_policy"
                )
        else:
            local_errors.append(
                "key_succession.signer_roster_quorum requires primary signer_roster_policy"
            )

        expected_policy_refs = [
            policy["policy_ref"]
            for policy in jurisdiction_policies
            if isinstance(policy, dict) and "policy_ref" in policy
        ]
        ...
        expected_roster_digests = [
            policy["signer_roster_digest"]
            for policy in jurisdiction_policies
            if isinstance(policy, dict) and "signer_roster_digest" in policy
        ]
        expected_signature_digests = [
            signer["signature_digest"]
            for policy in jurisdiction_policies
            if isinstance(policy, dict)
            for signer in policy.get("accepted_signers", [])
            if isinstance(signer, dict) and "signature_digest" in signer
        ]
        if receipt.get("jurisdiction_policy_refs") != expected_policy_refs:
            local_errors.append(
                "key_succession.signer_roster_quorum.jurisdiction_policy_refs mismatch"
            )
        if receipt.get("jurisdiction_policy_digests") != expected_policy_digests:
            local_errors.append(
                "key_succession.signer_roster_quorum.jurisdiction_policy_digests mismatch"
            )
        if receipt.get("signer_roster_digest_set") != expected_roster_digests:
            local_errors.append(
                "key_succession.signer_roster_quorum.signer_roster_digest_set mismatch"
            )
        if receipt.get("signature_digest_set") != expected_signature_digests:
            local_errors.append(
        ...
        quorum_ok = (
            ...
            >= MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_QUORUM_THRESHOLD
            and set(MEMORY_REPLICATION_KEY_SUCCESSION_SIGNER_ROSTER_JURISDICTIONS)
        ...
        if not quorum_ok:
            local_errors.append(
                "key_succession.signer_roster_quorum must satisfy multi-jurisdiction signer roster quorum"
            )
        if receipt.get("quorum_status") != "complete":
            local_errors.append(
                "key_succession.signer_roster_quorum.quorum_status must equal 'complete'"
            )
        if receipt.get("raw_jurisdiction_policy_payload_stored") is not False:
            raw_jurisdiction_policy_payload_stored = True
            local_errors.append(
                "key_succession.signer_roster_quorum.raw_jurisdiction_policy_payload_stored must be false"
            )
        if receipt.get("raw_signer_roster_payload_stored") is not False:
            raw_signer_roster_payload_stored = True
            local_errors.append(
                "key_succession.signer_roster_quorum.raw_signer_roster_payload_stored must be false"
            )
        digest = receipt.get("digest")
        self._require_digest(
            digest,
            "key_succession.signer_roster_quorum.digest",
            local_errors,
        )
        if isinstance(digest, str):
            expected_digest = sha256_text(
            ...
            if digest != expected_digest:
                local_errors.append("key_succession.signer_roster_quorum.digest mismatch")
    ...
    def _build_long_term_media_renewal_receipt(
        self,
        *,
        identity_id: str,
        source_manifest_ref: str,
        ...
        replica_targets: Sequence[Dict[str, Any]],
        consensus_merkle_root: str,
    ) -> Dict[str, Any]:
        target_by_id = {
            target["target_id"]: target
            for target in replica_targets
            if target["target_id"] in MEMORY_REPLICATION_LONG_TERM_TARGETS
        }
        media_proofs = []
        for target_id in MEMORY_REPLICATION_LONG_TERM_TARGETS:
            target = target_by_id[target_id]
            storage_medium = (
                "optical-archive-refresh"
                if target_id == "coldstore"
                else "trustee-escrow-refresh"
            )
            medium_generation = f"{target_id}-media-generation-2"
            renewal_ref = (
                "media-renewal://memory-replication/"
                f"{identity_id}/{target_id}/generation-2"
            )
            ...
            proof = {
                ...
                "source_replica_attestation_ref": target["attestation_ref"],
                "source_merkle_root": consensus_merkle_root,
                "renewal_ref": renewal_ref,
                "renewed_bundle_ref": f"{target['encrypted_bundle_ref']}/media-generation-2",
                "renewed_merkle_root": sha256_text(
                    canonical_json(
                        {
                            "identity_id": identity_id,
                            "target_id": target_id,
                ...
                "migration_attestation_ref": (
                    f"attestation://memory-replication/{target_id}/media-renewal"
                ),
                "migration_attestation_digest": sha256_text(
                    canonical_json(
                        {
                            "identity_id": identity_id,
                            "target_id": target_id,
                ...
                "next_refresh_due_days": MEMORY_REPLICATION_MEDIA_RENEWAL_REFRESH_INTERVAL_DAYS,
                "raw_media_payload_stored": False,
                "raw_readback_payload_stored": False,
            }
            proof["proof_digest"] = sha256_text(
                canonical_json(_memory_replication_media_proof_digest_payload(proof))
            )
        ...
        receipt = {
            ...
            "renewal_receipt_id": new_id("memory-media-renewal"),
            "identity_id": identity_id,
            "source_manifest_ref": source_manifest_ref,
            "source_manifest_digest": source_manifest_digest,
            "source_segment_ids": list(source_segment_ids),
            ...
            "status": "renewed-and-readback-verified",
        }
        receipt["digest"] = sha256_text(
    ...
    def _build_long_term_media_renewal_refresh_window(
        ...
        *,
        ...
        registry_verifier = self._build_long_term_media_renewal_registry_verifier(
            identity_id=identity_id,
            source_manifest_digest=source_manifest_digest,
            renewal_target_ids=renewal_target_ids,
            proof_digest_set=proof_digest_set,
            readback_digest_set=readback_digest_set,
    ...
    def _build_long_term_media_renewal_registry_verifier(
        self,
        *,
        identity_id: str,
        source_manifest_digest: str,
        ...
        registry_jurisdictions = list(
            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS
        )
        registry_endpoint_refs = [
            (
                "registry://memory-replication/"
                f"{jurisdiction.lower()}/media-renewal/status/v1"
            )
            for jurisdiction in registry_jurisdictions
        ]
            ...
            canonical_json(
                {
                    ...
                    "renewal_target_ids": list(renewal_target_ids),
                    "source_media_proof_set_digest": source_media_proof_set_digest,
                    "revocation_registry_refs": list(revocation_registry_refs),
        ...
        for jurisdiction, endpoint_ref in zip(
                ...
                canonical_json(
                    {
                        ...
                        "source_manifest_digest": source_manifest_digest,
                        "source_media_proof_set_digest": source_media_proof_set_digest,
                        "revocation_registry_digest_set": list(
                            revocation_registry_digest_set
                        ),
                        "registry_status": "current-not-revoked",
                    }
                )
            )
            response_digest_set.append(response_digest)
            response_signature_digest_set.append(
                sha256_text(
                    canonical_json(
                        {
                            "jurisdiction": jurisdiction,
                            ...
                            "signer_ref": (
                                "signer://memory-replication/"
                                f"{jurisdiction.lower()}/media-registry"
                            ),
                        }
                    )
                )
        ...
        receipt = {
            "kind": "memory_replication_long_term_media_renewal_registry_verifier",
            "schema_version": MEMORY_REPLICATION_SCHEMA_VERSION,
            "policy_id": MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_VERIFIER_POLICY_ID,
            "verifier_receipt_id": new_id("memory-media-registry-verifier"),
            "identity_id": identity_id,
            "source_manifest_digest": source_manifest_digest,
            "renewal_target_ids": list(renewal_target_ids),
            "source_proof_digest_set": list(proof_digest_set),
            ...
            "registry_endpoint_refs": registry_endpoint_refs,
            "request_payload_digest": request_payload_digest,
            "response_payload_kind": "media-renewal-registry-status-response",
            "response_timeout_ms": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_RESPONSE_TIMEOUT_MS
            ),
            "response_digest_set": response_digest_set,
    ...
    def _build_long_term_media_renewal_registry_endpoint_certificate_lifecycle(
        ...
        *,
        ...
        ct_log_refs = []
        ct_log_leaf_digest_set = []
        ct_log_inclusion_proof_digest_set = []
        ct_log_readback_digest_set = []
        ct_log_quorum_digest_set = []
        sct_timestamp_digest_set = []
        sct_policy_registry_refs = []
        sct_policy_registry_digest_set = []
        sct_signer_roster_refs = []
        sct_signer_roster_digest_set = []
        sct_signer_verifier_quorum_digest_set = []
        sct_policy_authority_digest_set = []
        for jurisdiction, endpoint_ref, response_digest in zip(
            ...
            endpoint_ct_log_refs = [
                (
                    "certificate-transparency-log://memory-replication/"
                    f"{jurisdiction_key}/media-registry-endpoint/primary"
                ),
                (
                    "certificate-transparency-log://memory-replication/"
                    f"{jurisdiction_key}/media-registry-endpoint/backup"
                ),
            ]
            ct_log_leaf_digest = sha256_text(
                canonical_json(
                    {
                        "jurisdiction": jurisdiction,
                        "certificate_ref": certificate_ref,
                        "certificate_fingerprint": certificate_fingerprint,
                        "certificate_chain_digest": certificate_chain_digest,
                        "source_manifest_digest": source_manifest_digest,
                    }
                )
            )
            endpoint_ct_log_inclusion_digests = [
                sha256_text(
                    canonical_json(
                        {
                            "jurisdiction": jurisdiction,
                ...
                for ct_log_ref in endpoint_ct_log_refs
            ]
            ct_log_readback_digest = sha256_text(
                canonical_json(
                    {
                        "policy_id": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_READBACK_POLICY_ID
                        ...
                        "jurisdiction": jurisdiction,
                        "ct_log_ref": endpoint_ct_log_refs[0],
                        "ct_log_leaf_digest": ct_log_leaf_digest,
            ...
            ct_log_quorum_digest = sha256_text(
                canonical_json(
                    {
                        "policy_id": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID
                        ...
                        "jurisdiction": jurisdiction,
                        "ct_log_refs": endpoint_ct_log_refs,
                        "ct_log_leaf_digest": ct_log_leaf_digest,
                        "ct_log_inclusion_proof_digests": (
                            endpoint_ct_log_inclusion_digests
                        ),
                        "ct_log_readback_digest": ct_log_readback_digest,
                        "required_log_count": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_REQUIRED_LOG_COUNT
                        ),
                        "status": "complete",
            ...
            sct_timestamp_digest = sha256_text(
                canonical_json(
                    {
                        "jurisdiction": jurisdiction,
                        "ct_log_quorum_digest": ct_log_quorum_digest,
                        "timestamp_window_seconds": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_TIMESTAMP_WINDOW_SECONDS
                        ),
                        "registry_response_signature_digest": response_signature_digest_set[
                            len(ct_log_refs)
                        ],
            ...
            sct_policy_registry_ref = (
                "sct-policy-registry://memory-replication/"
                f"{jurisdiction_key}/media-registry-endpoint"
            )
            sct_policy_registry_digest = sha256_text(
                canonical_json(
                    {
                        "jurisdiction": jurisdiction,
                        "policy_registry_ref": sct_policy_registry_ref,
                        "ct_log_quorum_policy_id": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID
                        ),
                        "timestamp_window_seconds": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_TIMESTAMP_WINDOW_SECONDS
            ...
            sct_signer_roster_ref = (
                "sct-signer-roster://memory-replication/"
                f"{jurisdiction_key}/media-registry-endpoint"
            )
            sct_signer_roster_digest = sha256_text(
                canonical_json(
                    {
                        "jurisdiction": jurisdiction,
            ...
            sct_signer_verifier_quorum_digest = sha256_text(
                canonical_json(
                    {
                        "jurisdiction": jurisdiction,
                        "sct_signer_roster_digest": sct_signer_roster_digest,
                        "registry_response_signature_digest": response_signature_digest_set[
                            len(ct_log_refs)
                        ],
                        "quorum_status": "complete",
            ...
            sct_policy_authority_digest = sha256_text(
                canonical_json(
                    {
                        "policy_id": (
                            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_POLICY_AUTHORITY_POLICY_ID
                        ...
                        "jurisdiction": jurisdiction,
                        "sct_policy_registry_digest": sct_policy_registry_digest,
                        "sct_signer_roster_digest": sct_signer_roster_digest,
            ...
            ct_log_readback_digest_set.append(ct_log_readback_digest)
            ct_log_quorum_digest_set.append(ct_log_quorum_digest)
            sct_timestamp_digest_set.append(sct_timestamp_digest)
            sct_policy_registry_refs.append(sct_policy_registry_ref)
            sct_policy_registry_digest_set.append(sct_policy_registry_digest)
            sct_signer_roster_refs.append(sct_signer_roster_ref)
            sct_signer_roster_digest_set.append(sct_signer_roster_digest)
            sct_signer_verifier_quorum_digest_set.append(
                sct_signer_verifier_quorum_digest
            )
            sct_policy_authority_digest_set.append(sct_policy_authority_digest)

        ct_log_readback_set_digest = sha256_text(
            canonical_json(
                {
                    "policy_id": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_READBACK_POLICY_ID
                    ),
                    "ct_log_readback_digest_set": ct_log_readback_digest_set,
                    "endpoint_certificate_fingerprints": endpoint_certificate_fingerprints,
                }
            )
        )
        ct_log_quorum_set_digest = sha256_text(
            canonical_json(
                {
                    "policy_id": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID
                    ),
                    "ct_log_quorum_digest_set": ct_log_quorum_digest_set,
                    "sct_timestamp_digest_set": sct_timestamp_digest_set,
                    "required_log_count": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_REQUIRED_LOG_COUNT
                    ),
                }
        ...
        sct_policy_authority_set_digest = sha256_text(
            canonical_json(
                {
                    "policy_id": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_POLICY_AUTHORITY_POLICY_ID
                    ...
                    "sct_policy_registry_digest_set": sct_policy_registry_digest_set,
                    "sct_signer_roster_digest_set": sct_signer_roster_digest_set,
                }
            )
        )
            ...
            canonical_json(
                {
                    ...
                    "ct_log_readback_set_digest": ct_log_readback_set_digest,
                    "ct_log_quorum_set_digest": ct_log_quorum_set_digest,
                    "sct_policy_authority_set_digest": (
                        sct_policy_authority_set_digest
                    ),
        ...
        receipt = {
            ...
            "previous_retirement_digest_set": previous_retirement_digest_set,
            "ct_log_readback_policy_id": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_READBACK_POLICY_ID
            ),
            "ct_log_quorum_policy_id": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID
            ),
            "sct_policy_authority_policy_id": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_POLICY_AUTHORITY_POLICY_ID
            ),
            "ct_log_refs": ct_log_refs,
            "ct_log_leaf_digest_set": ct_log_leaf_digest_set,
            "ct_log_inclusion_proof_digest_set": ct_log_inclusion_proof_digest_set,
            "ct_log_readback_digest_set": ct_log_readback_digest_set,
            "ct_log_quorum_digest_set": ct_log_quorum_digest_set,
            "sct_timestamp_digest_set": sct_timestamp_digest_set,
            "sct_policy_registry_refs": sct_policy_registry_refs,
            "sct_policy_registry_digest_set": sct_policy_registry_digest_set,
            "sct_signer_roster_refs": sct_signer_roster_refs,
            "sct_signer_roster_digest_set": sct_signer_roster_digest_set,
            "sct_signer_verifier_quorum_digest_set": (
                sct_signer_verifier_quorum_digest_set
            ),
            "sct_policy_authority_digest_set": sct_policy_authority_digest_set,
            "ct_log_readback_set_digest": ct_log_readback_set_digest,
            "ct_log_quorum_set_digest": ct_log_quorum_set_digest,
            "sct_policy_authority_set_digest": sct_policy_authority_set_digest,
            "ct_log_quorum_required_log_count": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_REQUIRED_LOG_COUNT
            ),
            "sct_timestamp_window_seconds": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_TIMESTAMP_WINDOW_SECONDS
            ),
            ...
            "ct_log_readback_status": "current",
            "ct_log_quorum_status": "complete",
            "sct_policy_authority_status": "verified",
            ...
            "raw_certificate_ct_log_payload_stored": False,
    ...
    def _validate_long_term_media_renewal(
        self,
        receipt: Any,
        *,
        identity_id: Any,
        ...
        raw_media_registry_endpoint_certificate_ct_log_payload_stored = False
        raw_media_registry_endpoint_certificate_sct_policy_authority_payload_stored = False
        target_ids: List[str] = []
        readback_ok = False
        ...
        if receipt.get("kind") != "memory_replication_long_term_media_renewal":
            local_errors.append("long_term_media_renewal.kind mismatch")
        if receipt.get("schema_version") != MEMORY_REPLICATION_SCHEMA_VERSION:
            local_errors.append("long_term_media_renewal.schema_version mismatch")
        if receipt.get("policy_id") != MEMORY_REPLICATION_MEDIA_RENEWAL_POLICY_ID:
            local_errors.append("long_term_media_renewal.policy_id mismatch")
        self._require_non_empty_string(
            receipt.get("renewal_receipt_id"),
            "long_term_media_renewal.renewal_receipt_id",
            local_errors,
        )
        if receipt.get("identity_id") != identity_id:
            local_errors.append("long_term_media_renewal.identity_id must match session")
        if receipt.get("source_manifest_ref") != source_manifest_ref:
            local_errors.append(
                "long_term_media_renewal.source_manifest_ref must match session"
            )
        if receipt.get("source_manifest_digest") != source_manifest_digest:
            local_errors.append(
                "long_term_media_renewal.source_manifest_digest must match session"
            )
        receipt_segment_ids = self._validate_string_list(
            receipt.get("source_segment_ids"),
            "long_term_media_renewal.source_segment_ids",
            local_errors,
            unique=True,
        )
        if receipt_segment_ids != list(source_segment_ids):
            local_errors.append(
                "long_term_media_renewal.source_segment_ids must match session source_segment_ids"
            )
        self._require_digest(
            receipt.get("source_merkle_root"),
            "long_term_media_renewal.source_merkle_root",
            local_errors,
        )
        if isinstance(source_merkle_root, str) and receipt.get("source_merkle_root") != source_merkle_root:
            local_errors.append(
                "long_term_media_renewal.source_merkle_root must match verification consensus root"
            )
        target_ids = self._validate_target_list(
            receipt.get("renewal_target_ids"),
            "long_term_media_renewal.renewal_target_ids",
            local_errors,
            minimum=len(MEMORY_REPLICATION_LONG_TERM_TARGETS),
        )
        if target_ids != list(MEMORY_REPLICATION_LONG_TERM_TARGETS):
            local_errors.append("long_term_media_renewal.renewal_target_ids mismatch")

        media_proofs = receipt.get("media_proofs")
        if not isinstance(media_proofs, list):
            local_errors.append("long_term_media_renewal.media_proofs must be a list")
            media_proofs = []
        if len(media_proofs) != len(MEMORY_REPLICATION_LONG_TERM_TARGETS):
            local_errors.append("long_term_media_renewal.media_proofs length mismatch")

        proof_digest_set: List[str] = []
        readback_digest_set: List[str] = []
        proof_target_ids: List[str] = []
        proof_readback_statuses: List[str] = []
        for index, proof in enumerate(media_proofs):
            if not isinstance(proof, dict):
                local_errors.append(
                    f"long_term_media_renewal.media_proofs[{index}] must be an object"
                )
                continue
            proof_prefix = f"long_term_media_renewal.media_proofs[{index}]"
            target_id = proof.get("target_id")
            if target_id not in MEMORY_REPLICATION_LONG_TERM_TARGETS:
                local_errors.append(f"{proof_prefix}.target_id must be a long-term target")
            elif isinstance(target_id, str):
                proof_target_ids.append(target_id)
            for field_name in (
                "storage_medium",
                "medium_generation",
                "source_replica_attestation_ref",
                "renewal_ref",
                "renewed_bundle_ref",
                "migration_attestation_ref",
            ):
                self._require_non_empty_string(
                    ...
                    f"{proof_prefix}.{field_name}",
                    local_errors,
                )
            if proof.get("source_merkle_root") != receipt.get("source_merkle_root"):
                local_errors.append(f"{proof_prefix}.source_merkle_root mismatch")
            self._require_digest(
                proof.get("renewed_merkle_root"),
                f"{proof_prefix}.renewed_merkle_root",
                local_errors,
            )
            self._require_digest(
                proof.get("readback_digest"),
                f"{proof_prefix}.readback_digest",
                local_errors,
            )
            if isinstance(proof.get("readback_digest"), str):
                readback_digest_set.append(proof["readback_digest"])
                expected_readback_digest = sha256_text(
                    canonical_json(
                        {
                            "identity_id": identity_id,
                            "target_id": target_id,
                            "source_manifest_digest": source_manifest_digest,
                            "source_merkle_root": receipt.get("source_merkle_root"),
                            "source_segment_ids": list(source_segment_ids),
                            "renewal_ref": proof.get("renewal_ref"),
                        }
                    )
                )
                if proof["readback_digest"] != expected_readback_digest:
                    local_errors.append(f"{proof_prefix}.readback_digest mismatch")
            if proof.get("readback_status") != "verified":
                local_errors.append(f"{proof_prefix}.readback_status must equal verified")
            else:
                proof_readback_statuses.append("verified")
            self._require_digest(
                proof.get("migration_attestation_digest"),
                f"{proof_prefix}.migration_attestation_digest",
                local_errors,
            )
                ...
                canonical_json(
                    {
                        ...
                        "target_id": target_id,
                        "renewal_ref": proof.get("renewal_ref"),
                        "readback_digest": proof.get("readback_digest"),
                        "source_manifest_digest": source_manifest_digest,
                    }
                )
            )
            if proof.get("migration_attestation_digest") != expected_attestation_digest:
                local_errors.append(
                    f"{proof_prefix}.migration_attestation_digest mismatch"
                )
            if (
                proof.get("target_horizon_years")
                != MEMORY_REPLICATION_MEDIA_RENEWAL_TARGET_HORIZON_YEARS
            ):
                local_errors.append(f"{proof_prefix}.target_horizon_years mismatch")
            if (
                proof.get("next_refresh_due_days")
                != MEMORY_REPLICATION_MEDIA_RENEWAL_REFRESH_INTERVAL_DAYS
            ):
                local_errors.append(f"{proof_prefix}.next_refresh_due_days mismatch")
            if proof.get("raw_media_payload_stored") is not False:
                raw_media_payload_stored = True
                local_errors.append(
                    f"{proof_prefix}.raw_media_payload_stored must be false"
                )
            if proof.get("raw_readback_payload_stored") is not False:
                raw_media_readback_payload_stored = True
                local_errors.append(
                    f"{proof_prefix}.raw_readback_payload_stored must be false"
                )
            self._require_digest(
                proof.get("proof_digest"),
                f"{proof_prefix}.proof_digest",
                local_errors,
            )
            if isinstance(proof.get("proof_digest"), str):
                proof_digest_set.append(proof["proof_digest"])
                expected_proof_digest = sha256_text(
                    canonical_json(_memory_replication_media_proof_digest_payload(proof))
                )
                if proof["proof_digest"] != expected_proof_digest:
                    local_errors.append(f"{proof_prefix}.proof_digest mismatch")

        if proof_target_ids != list(MEMORY_REPLICATION_LONG_TERM_TARGETS):
            local_errors.append("long_term_media_renewal.media_proofs target order mismatch")
        if receipt.get("proof_digest_set") != proof_digest_set:
        ...
        self._require_non_empty_string(
            receipt.get("next_refresh_due_ref"),
        ...
        raw_media_registry_payload_stored = refresh_window_validation[
            "raw_media_registry_payload_stored"
        ]
        ...
        self._require_non_empty_string(
            receipt.get("guardian_attestation_ref"),
            "long_term_media_renewal.guardian_attestation_ref",
            local_errors,
        )
        if receipt.get("raw_media_payload_stored") is not False:
            raw_media_payload_stored = True
            local_errors.append(
                "long_term_media_renewal.raw_media_payload_stored must be false"
            )
        if receipt.get("raw_media_readback_payload_stored") is not False:
            raw_media_readback_payload_stored = True
            local_errors.append(
                "long_term_media_renewal.raw_media_readback_payload_stored must be false"
            )
        if receipt.get("status") != "renewed-and-readback-verified":
            local_errors.append(
                "long_term_media_renewal.status must equal renewed-and-readback-verified"
            )
        digest = receipt.get("digest")
        self._require_digest(digest, "long_term_media_renewal.digest", local_errors)
        if isinstance(digest, str):
            expected_digest = sha256_text(
                canonical_json(_memory_replication_media_renewal_digest_payload(receipt))
            )
            if digest != expected_digest:
                local_errors.append("long_term_media_renewal.digest mismatch")
        ...
        return {
            ...
            "registry_verifier_bound": refresh_window_validation[
                "registry_verifier_bound"
            ],
            ...
            "registry_endpoint_certificate_ct_log_bound": refresh_window_validation[
                "registry_endpoint_certificate_ct_log_bound"
            ],
            "registry_endpoint_certificate_ct_log_quorum_ok": (
                refresh_window_validation[
        ...
        *,
        ...
        registry_verifier_validation = (
            self._validate_long_term_media_renewal_registry_verifier(
                ...
                proof_digest_set=proof_digest_set,
                readback_digest_set=readback_digest_set,
                source_media_proof_set_digest=expected_media_proof_set_digest,
                revocation_registry_refs=revocation_registry_refs,
                revocation_registry_digest_set=revocation_registry_digest_set,
                errors=local_errors,
            )
        ...
        registry_endpoint_certificate_ct_log_bound = (
            registry_verifier_validation["endpoint_certificate_ct_log_bound"]
        )
        registry_endpoint_certificate_ct_log_quorum_ok = (
            registry_verifier_validation["endpoint_certificate_ct_log_quorum_ok"]
        )
        registry_endpoint_certificate_sct_policy_authority_bound = (
            registry_verifier_validation[
        ...
        revocation_check_ok = (
            ...
            and registry_endpoint_certificate_ct_log_bound
            and registry_endpoint_certificate_ct_log_quorum_ok
            and registry_endpoint_certificate_sct_policy_authority_bound
    ...
    def _validate_long_term_media_renewal_registry_verifier(
        self,
        receipt: Any,
        *,
        identity_id: Any,
        ...
        if (
            receipt.get("kind")
            != "memory_replication_long_term_media_renewal_registry_verifier"
        ):
            local_errors.append(f"{prefix}.kind mismatch")
        if receipt.get("schema_version") != MEMORY_REPLICATION_SCHEMA_VERSION:
            local_errors.append(f"{prefix}.schema_version mismatch")
        ...
        self._require_non_empty_string(
            ...
            f"{prefix}.verifier_receipt_id",
            local_errors,
        )
        if receipt.get("identity_id") != identity_id:
            local_errors.append(f"{prefix}.identity_id must match refresh window")
        if receipt.get("source_manifest_digest") != source_manifest_digest:
            local_errors.append(
                f"{prefix}.source_manifest_digest must match refresh window"
            )
        ...
        if receipt.get("source_media_proof_set_digest") != source_media_proof_set_digest:
            local_errors.append(f"{prefix}.source_media_proof_set_digest mismatch")
        if receipt.get("revocation_registry_refs") != list(revocation_registry_refs):
            local_errors.append(f"{prefix}.revocation_registry_refs mismatch")
        if receipt.get("revocation_registry_digest_set") != list(
            revocation_registry_digest_set
        ):
            local_errors.append(f"{prefix}.revocation_registry_digest_set mismatch")
        registry_jurisdictions = self._validate_string_list(
            receipt.get("registry_jurisdictions"),
            f"{prefix}.registry_jurisdictions",
            local_errors,
            unique=True,
            minimum=len(MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS),
        )
        if registry_jurisdictions != list(
            MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS
        ):
            local_errors.append(f"{prefix}.registry_jurisdictions mismatch")
        registry_endpoint_refs = self._validate_string_list(
            receipt.get("registry_endpoint_refs"),
            f"{prefix}.registry_endpoint_refs",
            local_errors,
            unique=True,
            minimum=len(MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS),
        )
        expected_registry_endpoint_refs = [
            (
                "registry://memory-replication/"
                f"{jurisdiction.lower()}/media-renewal/status/v1"
            )
        ...
        if registry_endpoint_refs != expected_registry_endpoint_refs:
            local_errors.append(f"{prefix}.registry_endpoint_refs mismatch")

        expected_request_payload_digest = sha256_text(
            canonical_json(
                {
                    "identity_id": identity_id,
                    "source_manifest_digest": source_manifest_digest,
                    ...
                    "source_media_proof_set_digest": source_media_proof_set_digest,
                    "revocation_registry_refs": list(revocation_registry_refs),
                    "registry_endpoint_refs": expected_registry_endpoint_refs,
                }
            )
        )
        self._require_digest(
            receipt.get("request_payload_digest"),
            f"{prefix}.request_payload_digest",
            local_errors,
        )
        if receipt.get("request_payload_digest") != expected_request_payload_digest:
            local_errors.append(f"{prefix}.request_payload_digest mismatch")
        if receipt.get("response_payload_kind") != "media-renewal-registry-status-response":
            local_errors.append(f"{prefix}.response_payload_kind mismatch")
        if (
            receipt.get("response_timeout_ms")
            != MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_RESPONSE_TIMEOUT_MS
        ):
            local_errors.append(f"{prefix}.response_timeout_ms mismatch")

        expected_response_digest_set = []
        ...
        for jurisdiction, endpoint_ref in zip(
            ...
            expected_response_digest_set.append(response_digest)
            expected_response_signature_digest_set.append(
                sha256_text(
                    canonical_json(
                        {
                            "jurisdiction": jurisdiction,
        ...
        response_digest_set = self._validate_digest_list(
            receipt.get("response_digest_set"),
            f"{prefix}.response_digest_set",
            local_errors,
            minimum=len(MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS),
        )
        if response_digest_set != expected_response_digest_set:
            local_errors.append(f"{prefix}.response_digest_set mismatch")
        response_signature_digest_set = self._validate_digest_list(
            receipt.get("response_signature_digest_set"),
            f"{prefix}.response_signature_digest_set",
            local_errors,
            minimum=len(MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_JURISDICTIONS),
        )
        ...
        self._require_digest(
            receipt.get("registry_quorum_digest"),
            f"{prefix}.registry_quorum_digest",
            local_errors,
        )
        if receipt.get("registry_quorum_digest") != expected_registry_quorum_digest:
            local_errors.append(f"{prefix}.registry_quorum_digest mismatch")
        if (
            receipt.get("quorum_threshold")
            != MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_QUORUM_THRESHOLD
        ):
        ...
        if receipt.get("registry_status") != "current-not-revoked":
            local_errors.append(f"{prefix}.registry_status must equal current-not-revoked")
        if receipt.get("raw_registry_payload_stored") is not False:
            raw_media_registry_payload_stored = True
            local_errors.append(f"{prefix}.raw_registry_payload_stored must be false")
        if receipt.get("raw_response_payload_stored") is not False:
            raw_media_registry_response_payload_stored = True
            local_errors.append(f"{prefix}.raw_response_payload_stored must be false")
        digest = receipt.get("digest")
        ...
        quorum_ok = (
            len(response_digest_set)
            >= MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_QUORUM_THRESHOLD
            and len(response_signature_digest_set)
            >= MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_QUORUM_THRESHOLD
        ...
        return {
            ...
            "endpoint_certificate_ct_log_bound": (
                endpoint_certificate_lifecycle_validation["ct_log_bound"]
            ),
            "endpoint_certificate_ct_log_quorum_ok": (
                endpoint_certificate_lifecycle_validation["ct_log_quorum_ok"]
            ),
            "endpoint_certificate_sct_policy_authority_bound": (
                endpoint_certificate_lifecycle_validation[
    ...
    def _validate_long_term_media_renewal_registry_endpoint_certificate_lifecycle(
        ...
        *,
        ...
        expected_ct_log_refs = []
        expected_ct_log_leaf_digest_set = []
        expected_ct_log_inclusion_proof_digest_set = []
        expected_ct_log_readback_digest_set = []
        expected_ct_log_quorum_digest_set = []
        expected_sct_timestamp_digest_set = []
        expected_sct_policy_registry_refs = []
        expected_sct_policy_registry_digest_set = []
        expected_sct_signer_roster_refs = []
        expected_sct_signer_roster_digest_set = []
        expected_sct_signer_verifier_quorum_digest_set = []
        expected_sct_policy_authority_digest_set = []
        for jurisdiction, endpoint_ref, response_digest in zip(
            registry_jurisdictions,
            registry_endpoint_refs,
            response_digest_set,
            ...
            expected_ct_log_readback_digest_set.append(ct_log_readback_digest)
            expected_ct_log_quorum_digest_set.append(ct_log_quorum_digest)
            expected_sct_timestamp_digest_set.append(sct_timestamp_digest)
            expected_sct_policy_registry_refs.append(sct_policy_registry_ref)
            expected_sct_policy_registry_digest_set.append(sct_policy_registry_digest)
            expected_sct_signer_roster_refs.append(sct_signer_roster_ref)
            expected_sct_signer_roster_digest_set.append(sct_signer_roster_digest)
            expected_sct_signer_verifier_quorum_digest_set.append(
                sct_signer_verifier_quorum_digest
            )
            expected_sct_policy_authority_digest_set.append(
        ...
        expected_lists = {
            ...
            "ct_log_refs": expected_ct_log_refs,
            "ct_log_leaf_digest_set": expected_ct_log_leaf_digest_set,
            "ct_log_inclusion_proof_digest_set": (
                expected_ct_log_inclusion_proof_digest_set
            ),
            "ct_log_readback_digest_set": expected_ct_log_readback_digest_set,
            "ct_log_quorum_digest_set": expected_ct_log_quorum_digest_set,
            "sct_timestamp_digest_set": expected_sct_timestamp_digest_set,
            "sct_policy_registry_refs": expected_sct_policy_registry_refs,
            "sct_policy_registry_digest_set": (
                expected_sct_policy_registry_digest_set
            ),
            "sct_signer_roster_refs": expected_sct_signer_roster_refs,
            "sct_signer_roster_digest_set": expected_sct_signer_roster_digest_set,
            "sct_signer_verifier_quorum_digest_set": (
                expected_sct_signer_verifier_quorum_digest_set
            ),
            "sct_policy_authority_digest_set": (
        ...
        expected_ct_log_readback_set_digest = sha256_text(
            canonical_json(
                {
                    "policy_id": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_READBACK_POLICY_ID
        ...
        expected_ct_log_quorum_set_digest = sha256_text(
            canonical_json(
                {
                    "policy_id": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_POLICY_ID
        ...
        expected_sct_policy_authority_set_digest = sha256_text(
            canonical_json(
                {
                    "policy_id": (
                        MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_SCT_POLICY_AUTHORITY_POLICY_ID
        ...
        expected_scalar_fields = {
            ...
            "ct_log_readback_set_digest": expected_ct_log_readback_set_digest,
            "ct_log_quorum_set_digest": expected_ct_log_quorum_set_digest,
            "sct_policy_authority_set_digest": (
                expected_sct_policy_authority_set_digest
            ),
            "ct_log_quorum_required_log_count": (
                MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_REQUIRED_LOG_COUNT
            ),
        ...
        for field_name, expected_value in expected_scalar_fields.items():
            if receipt.get(field_name) != expected_value:
                local_errors.append(f"{prefix}.{field_name} mismatch")
            ...
            canonical_json(
                {
                    ...
                    "ct_log_readback_set_digest": (
                        expected_ct_log_readback_set_digest
                    ),
                    "ct_log_quorum_set_digest": expected_ct_log_quorum_set_digest,
                    "sct_policy_authority_set_digest": (
                        expected_sct_policy_authority_set_digest
        ...
        if receipt.get("ct_log_readback_status") != "current":
            local_errors.append(f"{prefix}.ct_log_readback_status must equal current")
        if receipt.get("ct_log_quorum_status") != "complete":
            local_errors.append(f"{prefix}.ct_log_quorum_status must equal complete")
        if receipt.get("sct_policy_authority_status") != "verified":
            local_errors.append(
                f"{prefix}.sct_policy_authority_status must equal verified"
            )
        ...
        if receipt.get("raw_certificate_ct_log_payload_stored") is not False:
            raw_certificate_ct_log_payload_stored = True
            local_errors.append(
                f"{prefix}.raw_certificate_ct_log_payload_stored must be false"
            )
        if receipt.get("raw_sct_policy_authority_payload_stored") is not False:
            raw_sct_policy_authority_payload_stored = True
            local_errors.append(
                f"{prefix}.raw_sct_policy_authority_payload_stored must be false"
            )
        digest = receipt.get("digest")
        self._require_digest(digest, f"{prefix}.digest", local_errors)
        if isinstance(digest, str):
        ...
        freshness_ok = (
            ...
            and receipt.get("ct_log_readback_status") == "current"
            and receipt.get("ct_log_quorum_status") == "complete"
            and receipt.get("sct_policy_authority_status") == "verified"
            and not raw_certificate_ct_log_payload_stored
            and not raw_sct_policy_authority_payload_stored
            and not local_errors
        )
        ct_log_bound = (
            receipt.get("ct_log_readback_set_digest")
            == expected_ct_log_readback_set_digest
            and receipt.get("ct_log_readback_status") == "current"
            and not raw_certificate_ct_log_payload_stored
            and not local_errors
        ...
        ct_log_quorum_ok = (
            ct_log_bound
            and receipt.get("ct_log_quorum_set_digest")
            == expected_ct_log_quorum_set_digest
            and receipt.get("ct_log_quorum_status") == "complete"
            and receipt.get("ct_log_quorum_required_log_count")
            == MEMORY_REPLICATION_MEDIA_RENEWAL_REGISTRY_ENDPOINT_CERTIFICATE_CT_LOG_QUORUM_REQUIRED_LOG_COUNT
            and not local_errors
        )
        sct_policy_authority_bound = (
            receipt.get("sct_policy_authority_set_digest")
            == expected_sct_policy_authority_set_digest
            and receipt.get("sct_policy_authority_status") == "verified"
            and not raw_sct_policy_authority_payload_stored
            and not local_errors
        ...
        quorum_ok = (
            ...
            == expected_certificate_lifecycle_quorum_digest
            and receipt.get("ct_log_readback_set_digest")
            == expected_ct_log_readback_set_digest
            and receipt.get("ct_log_quorum_set_digest")
            == expected_ct_log_quorum_set_digest
            and receipt.get("sct_policy_authority_set_digest")
            == expected_sct_policy_authority_set_digest
            and freshness_ok
            and not local_errors
        )
