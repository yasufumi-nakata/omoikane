...
class VersioningSchemaContractTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_version_demo_catalog_inventory_receipt_matches_public_schema(self) -> None:
        result = self.runtime.run_version_demo()

        self._assert_schema_valid(
            "specs/schemas/catalog_inventory_receipt.schema",
            result["manifest"]["catalog_inventory_receipt"],
        )

    def test_version_demo_release_manifest_matches_public_schema(self) -> None:
        result = self.runtime.run_version_demo()
