...
class TerminationSchemaContractTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_termination_demo_outcomes_match_public_schema(self) -> None:
        result = self.runtime.run_termination_demo()

        for outcome in result["outcomes"].values():
            self._assert_schema_valid("specs/schemas/termination_outcome.schema", outcome)
