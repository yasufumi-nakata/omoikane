...
class IdentitySchemaContractTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_identity_confirmation_profile_matches_public_schema(self) -> None:
        result = self.runtime.run_identity_confirmation_demo()

        self._assert_schema_valid(
            "specs/schemas/identity_confirmation_profile.schema",
            result["confirmation_profile"],
        )
        self._assert_schema_valid(
            "specs/schemas/identity_confirmation_profile.schema",
