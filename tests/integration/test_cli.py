...
class CliIntegrationTests(unittest.TestCase):
    ...
    def test_gap_report_emits_reference_ready_json(self) -> None:
        ...
        self.assertEqual(0, result["schema_example_validation_count"])
        self.assertEqual([], result["schema_example_validation_hits"])
        ...
        self.assertEqual(0, result["ignored_generated_artifact_count"])
        self.assertEqual([], result["ignored_generated_artifact_hits"])
        ...
        self.assertEqual([], result["decision_log_metadata_violation_hits"])
    ...
    def test_biodata_transmitter_demo_emits_body_state_roundtrip(self) -> None:
        ...
        self.assertFalse(result["survey_eeg_fusion"]["raw_survey_response_payload_stored"])
        self.assertFalse(result["survey_eeg_fusion"]["raw_eeg_samples_stored"])
        self.assertFalse(result["survey_eeg_fusion"]["raw_fusion_payload_stored"])
    ...
    def test_observation_integration_demo_emits_universal_observation_package(self) -> None:
        ...
        self.assertGreaterEqual(result["validation"]["measurement_method_count"], 40)
        self.assertGreaterEqual(result["validation"]["analysis_method_count"], 40)
    ...
    def test_ewa_demo_emits_vetoed_irreversible_command(self) -> None:
        ...
        self.assertTrue(result["validation"]["regulator_permit_quorum_multi_jurisdiction_bound"])
        self.assertTrue(result["validation"]["regulator_permit_quorum_threshold_policy_bound"])
        self.assertTrue(result["validation"]["regulator_permit_quorum_roster_bound"])
        self.assertTrue(result["validation"]["regulator_permit_quorum_revocation_registry_bound"])
