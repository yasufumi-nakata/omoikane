...
class ReferenceRuntimeTests(unittest.TestCase):
    ...
    def test_neuro_integration_demo_reports_llm_native_multi_app_workbench(self) -> None:
        ...
        self.assertEqual(8, result["validation"]["source_count"])
        ...
        self.assertEqual(8, result["validation"]["collection_step_count"])
        ...
        self.assertEqual(8, result["validation"]["collection_result_count"])
        ...
        self.assertEqual(8, result["validation"]["measurement_quality_item_count"])
        ...
        self.assertEqual(28, result["validation"]["analysis_pair_count"])
        ...
        self.assertEqual(28, result["validation"]["analysis_result_count"])
        ...
        self.assertEqual(
            8,
            result["validation"]["longitudinal_stable_source_type_count"],
        )
        self.assertEqual(
            8,
        ...
        self.assertIn("biosensor", result["source_bundle"]["source_types"])
        ...
        self.assertEqual(
            1,
            result["ledger_verification"]["category_counts"][
                "interface-neuro-integration-workbench-interpretation"
            ],
        )
        self.assertEqual(
            1,
        ...
        self.assertEqual(
            1,
            result["ledger_verification"]["category_counts"][
                "interface-neuro-integration-workbench-collection-protocol"
            ],
        )
        self.assertEqual(
            1,
            result["ledger_verification"]["category_counts"][
                "interface-neuro-integration-workbench-collection-run"
            ],
        )
        self.assertEqual(
            1,
            result["ledger_verification"]["category_counts"][
                "interface-neuro-integration-workbench-quality-gate"
            ],
        )
        self.assertEqual(
            1,
    ...
    def test_collective_demo_reports_bounded_merge_and_dissolution(self) -> None:
        ...
        self.assertTrue(result["validation"]["recovery_capture_export_profile_bound"])
        self.assertTrue(result["validation"]["recovery_capture_export_route_trace_bound"])
        self.assertTrue(result["validation"]["recovery_capture_export_packet_capture_bound"])
        self.assertTrue(
            result["validation"]["recovery_capture_export_privileged_capture_bound"]
        )
        self.assertTrue(
            result["validation"]["recovery_capture_export_route_binding_set_bound"]
        )
    ...
    def test_gap_report_reads_repo(self) -> None:
        ...
        self.assertEqual(0, report["schema_example_validation_count"])
        self.assertEqual([], report["schema_example_validation_hits"])
        ...
        self.assertEqual(0, report["tracked_generated_artifact_count"])
    ...
    def test_memory_replication_demo_returns_quorum_bound_reconcile_session(self) -> None:
        ...
        self.assertEqual(
            3650,
            result["validation"]["long_term_media_renewal_refresh_interval_days"],
        )
        self.assertEqual(
            1000,
    ...
    def test_self_model_demo_reports_stable_and_abrupt_observations(self) -> None:
        ...
        self.assertEqual([], result["value_timeline"]["active_value_refs"])
    ...
    def test_yaoyorozu_demo_executes_local_worker_dispatch(self) -> None:
        ...
        self.assertTrue(result["validation"]["researcher_evidence_schema_contract_bound"])
