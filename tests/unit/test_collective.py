...
class CollectiveIdentityServiceTests(unittest.TestCase):
    ...
    def test_register_open_close_and_dissolve_collective(self) -> None:
        ...
        tampered_client_certificate_freshness_registry_sync = dict(registry_sync)
        tampered_client_certificate_freshness_registry_sync[
        ...
        tampered_client_certificate_ct_log_quorum_registry_sync = dict(registry_sync)
        tampered_client_certificate_ct_log_quorum_registry_sync[
            "ack_live_endpoint_mtls_client_certificate_ct_log_quorum_digest_set_digest"
        ] = "0" * 64
        tampered_client_certificate_ct_log_quorum_registry_validation = (
            service.validate_collective_external_registry_sync(
                tampered_client_certificate_ct_log_quorum_registry_sync,
                capture_binding,
                route_trace,
        ...
        tampered_client_certificate_sct_policy_registry_sync = dict(registry_sync)
        tampered_client_certificate_sct_policy_registry_sync[
            "ack_live_endpoint_mtls_client_certificate_sct_policy_authority_digest_set_digest"
        ] = "0" * 64
        tampered_client_certificate_sct_policy_registry_validation = (
            service.validate_collective_external_registry_sync(
                tampered_client_certificate_sct_policy_registry_sync,
                capture_binding,
                route_trace,
        ...
        for ct_log_proof in registry_sync[
            ...
            self.assertEqual(
                2,
                len(ct_log_proof["mtls_client_certificate_ct_log_quorum_log_refs"]),
            )
            self.assertEqual(
                "quorum-met",
                ct_log_proof["mtls_client_certificate_ct_log_quorum_status"],
            )
            self.assertEqual(
                "within-window",
                ct_log_proof["mtls_client_certificate_sct_timestamp_status"],
            )
        for sct_policy_proof in registry_sync[
        ...
        self.assertFalse(registry_sync["raw_sct_policy_authority_payload_stored"])
        ...
        self.assertFalse(tampered_client_certificate_freshness_registry_validation["ok"])
        self.assertFalse(
            tampered_client_certificate_freshness_registry_validation[
                "ack_live_endpoint_mtls_client_certificate_freshness_bound"
            ]
        ...
        self.assertFalse(tampered_client_certificate_ct_log_quorum_registry_validation["ok"])
        self.assertFalse(
            tampered_client_certificate_ct_log_quorum_registry_validation[
                "ack_live_endpoint_mtls_client_certificate_ct_log_quorum_bound"
            ]
        )
        self.assertFalse(tampered_client_certificate_sct_policy_registry_validation["ok"])
        self.assertFalse(
            tampered_client_certificate_sct_policy_registry_validation[
                "ack_live_endpoint_mtls_client_certificate_sct_policy_authority_bound"
            ]
